          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className="w-9 h-9 rounded-xl border border-gray-200 dark:border-slate-700 flex items-center justify-center hover:bg-gray-50 dark:hover:bg-slate-800 transition-all"
              >
                <Minus size={14} />
              </button>
