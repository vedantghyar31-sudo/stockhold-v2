...
export function ProductCard({ product, onClick }: Props) {
  ...
  return (
    ...
    >
      {/* Squircle image container — square aspect ratio, rounded corners */}
      <div className="relative w-full aspect-square bg-gray-50 dark:bg-slate-700 overflow-hidden rounded-t-2xl">
        {product.imageUrl ? (
      ...
      {/* Info */}
      <div className="p-3">
        <p className="font-semibold text-gray-900 dark:text-white text-sm truncate mb-0.5 leading-tight">
          {product.name}
        </p>
        <p className="text-blue-500 dark:text-blue-400 font-bold text-base leading-tight">
        ...
        <button
          ...
          className="mt-2 w-full flex items-center justify-center gap-1.5 py-1.5 text-xs font-semibold bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 rounded-xl hover:bg-blue-100 dark:hover:bg-blue-900/40 transition-all disabled:opacity-40 disabled:cursor-not-allowed"
        >
