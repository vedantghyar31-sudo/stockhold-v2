...
export default function ProductDetailPage() {
  ...
  return (
    <div className="max-w-xl mx-auto">
      <button
        onClick={() => router.back()}
        className="flex items-center gap-2 text-gray-500 dark:text-slate-400 hover:text-gray-800 dark:hover:text-white mb-5 text-sm font-medium"
      >
        <ArrowLeft size={17} />
        Back
      </button>
      ...
      <div className="bg-white dark:bg-slate-800 rounded-2xl border border-gray-100 dark:border-slate-700 shadow-sm p-6 mb-4">
        ...
        <div className="grid grid-cols-2 gap-3 mb-4">
          ...
          <div className="bg-green-50 dark:bg-green-900/20 rounded-xl p-3">
            <p className="text-xs text-green-500 mb-0.5">
              Profit / unit
            </p>
