...
export default function ProfilePage() {
  ...
  const expiryDate = subscription?.expiryDate?.toDate
    ? format(subscription.expiryDate.toDate(), 'dd MMM yyyy')
    : null;
    ...
    <div className="max-w-lg mx-auto">
      <div className="mb-6">
        ...
        <p className="text-gray-500 dark:text-slate-400 text-sm mt-1">
          Manage your account &amp; shop settings
        </p>
      </div>
      ...
      <div className="bg-white dark:bg-slate-800 rounded-2xl border border-gray-100 dark:border-slate-700 shadow-sm p-5 mb-4">
        ...
        <div className="space-y-3">
          ...
          <p className="text-xs text-gray-400 dark:text-slate-500">
            These details appear on all PDF invoices automatically.
          </p>
        </div>
      </div>
      ...
      <button
        ...
        className={`w-full flex items-center gap-4 p-4 rounded-2xl border mb-4 transition-all ${
          isActive
      ...
      >
        ...
        <div className="flex-1 text-left">
          ...
          <p className="text-xs text-gray-400 dark:text-slate-500 mt-0.5">
            {isActive && expiryDate
              ? `Renews ${expiryDate}`
              : `Subscribe for ${formatINR(2000)}/month`}
          </p>
        </div>
        ...
        {[
          ...
          <div
            ...
            className={`flex items-center gap-4 px-5 py-4 ${
              idx < arr.length - 1 ? 'border-b border-gray-50 dark:border-slate-700' : ''
            }`}
          >
      ...
      <div className="bg-white dark:bg-slate-800 rounded-2xl border border-gray-100 dark:border-slate-700 shadow-sm overflow-hidden mb-4">
        {[
          ...
          <button
            ...
            className={`w-full flex items-center justify-between px-5 py-4 hover:bg-gray-50 dark:hover:bg-slate-700 transition-all ${
              idx < arr.length - 1 ? 'border-b border-gray-50 dark:border-slate-700' : ''
            }`}
          >
      ...
      <p className="text-center text-xs text-gray-300 dark:text-slate-700 mt-8">
        Stockhold v2.0.0 · Made for Indian shop owners
      </p>
    </div>
  );
}
